...
<html lang="en">
    <head>
        <title>Brewtours - Our Tours</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <header class="header header--subpage header--subpage-tours">
            <div class="header__text-box">
                <h1 class="heading-primary">
                    <span class="heading-primary--sub">Available Tours</span>
                </h1>
            </div>
        </header>
        ...
        <main>
            <section class="tour-items">
                <div class="row">
                    <div class="col-1-3">
                        <div class="tour-card">
                            <div class="tour-card__side tour-card__side--top">
                                <div class="tour-card__picture tour-card__picture--1">
                                    &nbsp;
                                </div>
                                <div class="tour-card__heading">
                                    <div class="tour-card__heading-span tour-card__heading-span--1">
                                        Boston Pub Crawl
                                    </div>
                                </div>
                                ...
                                <div class="tour-card__side tour-card__side--bottom tour-card__side--bottom--1">
                                    <div class="tour-card__cta">
                                        <div class="tour-card__price-box">
                                            <p class="tour-card__price-only">Only</p>
                                            <p class="tour-card__price-value">$125</p>
                    ...
                    <div class="col-1-3">
                        <div class="tour-card">
                            <div class="tour-card__side tour-card__side--top">
                                <div class="tour-card__picture tour-card__picture--2">
                                    &nbsp;
                                </div>
                                <div class="tour-card__heading">
                                    <div class="tour-card__heading-span tour-card__heading-span--2">
                                        Northern RI Brewery Tour
                                    </div>
                                </div>
                                <div class="tour-card__details">
                                    <ul>
                                ...
                                <div class="tour-card__side tour-card__side--bottom tour-card__side--bottom--2">
                                    <div class="tour-card__cta">
                                        <div class="tour-card__price-box">
                                            <p class="tour-card__price-only">Only</p>
                                            <p class="tour-card__price-value">$65</p>
                                            <a href="#popup-1" class="btn btn--white">Book Now</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-1-3">
                        <div class="tour-card">
                            <div class="tour-card__side tour-card__side--top">
                                <div class="tour-card__picture tour-card__picture--3">
                                    &nbsp;
                                </div>
                                <div class="tour-card__heading">
                                    <div class="tour-card__heading-span tour-card__heading-span--3">
                                        Southern RI Brewery Tour
                                    </div>
                                </div>
                                <div class="tour-card__details">
                                    <ul>
                                ...
                                <div class="tour-card__side tour-card__side--bottom tour-card__side--bottom--3">
                                    <div class="tour-card__cta">
                                        <div class="tour-card__price-box">
                                            <p class="tour-card__price-only">Only</p>
                                            <p class="tour-card__price-value">$85</p>
                                            <a href="#popup-1" class="btn btn--white">Book Now</a>
                                        </div>
                                    </div>
                                </div>
